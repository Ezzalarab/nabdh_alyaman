...
**429** تم بلوغ الحد الأقصى لتسجيلات المتبرعين **في يوم UTC واحد** عندما يكون مفتاح الإعداد `max_registrations_per_day` موجوداً في قاعدة البيانات؛ يُحدَّد العدد من طرف المشرف عبر `PUT /app-config/max_registrations_per_day`.
